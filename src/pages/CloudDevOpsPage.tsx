...
const capabilities = [
  {
    ...
    description: 'Cloud foundations designed around security, resilience, performance, and the way your business operates.',
    icon: CloudCog,
  },
  {
    title: 'CI/CD & release automation',
    description: 'Reliable delivery pipelines that help teams ship changes with more confidence and less manual friction.',
    icon: GitBranch,
  },
  {
    title: 'Containers & infrastructure',
    description: 'Portable, repeatable environments for applications that need consistency from development to production.',
    icon: Boxes,
  },
  {
    title: 'Monitoring & reliability',
    description: 'Useful observability and operational signals that make systems easier to understand, maintain, and improve.',
    icon: Activity,
  },
]

const deliverySteps = [
  ['01', 'Assess', 'We map the current environment, risks, constraints, and the outcomes the platform must support.'],
  ['02', 'Engineer', 'We design and implement the architecture, automation, security controls, and delivery workflow.'],
  ['03', 'Operate', 'We establish the monitoring and operating practices that keep the system dependable over time.'],
]
        ...
        <div className="relative z-10 mx-auto grid w-full max-w-7xl gap-14 px-4 sm:px-6 lg:grid-cols-[1.05fr_0.95fr] lg:items-center lg:gap-20 lg:px-8">
          <div>
            ...
            <h1 className="mt-5 max-w-3xl text-5xl font-black leading-[0.95] text-brand-cream sm:text-7xl">
              Cloud infrastructure that stays ready for growth.
            </h1>
            <p className="mt-7 max-w-2xl text-lg leading-8 text-white/72 sm:text-xl">
              AWS architecture, CI/CD, containers, infrastructure, and monitoring for teams that
              need secure systems and dependable delivery.
            </p>
          ...
          <div className="relative rounded-2xl border border-white/12 bg-white/6 p-5 shadow-[0_24px_80px_rgba(0,0,0,0.2)] backdrop-blur-sm sm:p-7">
            <div className="flex items-center justify-between border-b border-white/10 pb-5">
              <div>
                ...
                <p className="mt-2 text-xl font-black text-white">Design. Ship. Observe.</p>
              </div>
            ...
            <div className="mt-5 space-y-3">
              {[
                ['01', 'Design for resilience'],
                ['02', 'Ship with confidence'],
                ['03', 'Observe what matters'],
              ].map(([number, item]) => (
                <div
                  key={number}
        ...
        <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <h2 className="mt-4 text-4xl font-black leading-tight text-brand-navy sm:text-5xl">
              The operating foundation behind dependable delivery.
            </h2>
            <p className="mt-5 max-w-2xl text-lg leading-8 text-brand-slate">
              Practical cloud engineering that connects architecture, release velocity, security,
      ...
      <section className="bg-brand-cream py-24 sm:py-28">
        <div className="mx-auto grid w-full max-w-7xl gap-14 px-4 sm:px-6 lg:grid-cols-[0.75fr_1.25fr] lg:items-start lg:gap-20 lg:px-8">
          <div>
            ...
            <h2 className="mt-4 text-4xl font-black leading-tight text-brand-navy sm:text-5xl">
              Infrastructure with a clear operating rhythm.
            </h2>
          </div>
        ...
        <div className="mx-auto flex w-full max-w-7xl flex-col gap-8 px-4 sm:px-6 lg:flex-row lg:items-center lg:justify-between lg:px-8">
          <div>
            ...
            <h2 className="mt-3 max-w-2xl text-3xl font-black leading-tight sm:text-4xl">
              Build a cloud platform your team can trust.
            </h2>
          </div>
          <Button to="/contact" variant="primary">
            Get In Touch
